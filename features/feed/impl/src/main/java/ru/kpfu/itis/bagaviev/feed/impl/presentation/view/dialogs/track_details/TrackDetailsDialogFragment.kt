package ru.kpfu.itis.bagaviev.feed.impl.presentation.view.dialogs.track_details
...
class TrackDetailsDialogFragment : BaseMusicDialogFragment(R.layout.fragment_track_details) {
            ...
            viewBinding?.apply {
                with(requireContext().resources) {
                    ...
                    tvTrackAuthors.text = getString(
                        ...
                        authors.joinToString(separator = " & ") { user -> user.login }
                    )
